...
def accumulate_ml_dataset(
    ...
    *,
    ...
    if accumulated.empty:
        ...
        if (
            deduplicate
            and "station_code" in combined.columns
            and "measurement_time" in combined.columns
        ):
            ...
            combined = combined.drop_duplicates(
                subset=["station_code", "measurement_time"], keep="first"
            )
